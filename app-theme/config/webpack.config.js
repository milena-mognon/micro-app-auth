...
for (const themeDir of themesDir) {
  ...
  for (const pageDir of pagesDirs) {
    const templateDirs = fs
      .readdirSync(path.join(paths.keycloakThemesPath, themeDir, pageDir))
      .filter(dir => dir.endsWith('-template'));

    for (const templateDir of templateDirs) {
      const ftlTmplates = fs
        .readdirSync(
          path.join(paths.keycloakThemesPath, themeDir, pageDir, templateDir)
        )
      ...
      if (ftlTmplates.length && componentPages.length) {
        const ftlTmplate = ftlTmplates[0];
          ...
          oneOf: [
            ...
            // https://github.com/jshttp/mime-db
            {
              ...
              options: {
                ...
                mimetype: 'image/avif',
                name: theme.themeDir + '/media/[name].[hash:8].[ext]',
              },
            },
